// Расширенная база психологических знаний для AI-коуча - Версия 1.3.0
...
export const psychologyKnowledgeBase: PsychologyKnowledge[] = [
    ...
    topics: [
      {
        ...
        techniques: [
          ...
          'Техника 5 "Почему?": спрашивайте себя почему трезвость важна, пока не дойдете до базовой ценности'
        ],
        resources: [
          'Книга: "Атомные привычки" Джеймс Клир',
          'Практика: Дневник благодарности за трезвость',
          'Видео: TED Talk "Сила привычек"',
          'Статья: "Построение новой идентичности в трезвости"'
        ]
      },
      {
        keyword: ['сорваться', 'не получится', 'не справлюсь', 'слабый', 'не верю'],
        ...
        techniques: [
          ...
          'Техника "Доказательства успеха": вспомните 3 случая, когда вы справились с трудностью'
        ],
        resources: [
          'Рабочая тетрадь CBT для зависимостей',
          'Приложение: Трекер когнитивных искажений',
          'Техника: ABCDE модель Альберта Эллиса',
          'Статья: "Переопределение успеха и неудачи"'
        ]
      },
      {
        keyword: ['прокрастинация', 'откладываю', 'лень', 'не могу начать'],
        response: 'Прокрастинация часто связана не с ленью, а с тревогой перед задачей или перфекционизмом. В трезвости мозг может сопротивляться новым усилиям. Важно снизить порог входа для действия.',
        techniques: [
          'Правило 5 минут: договоритесь делать задачу всего 5 минут',
          'Техника Помодоро: 25 минут работы, 5 минут отдыха',
          'Разбиение на "швейцарский сыр": выгрызайте в задаче маленькие кусочки по 2 минуты',
          'Устранение цифровых триггеров: уберите телефон в другую комнату'
        ],
        resources: [
          'Книга: "Легкий способ перестать откладывать на потом" Нил Фьоре',
          'Приложение: Forest для концентрации',
          'Статья: "Тайм-менеджмент: как не перегрузить себя"'
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        keyword: ['тревога', 'паника', 'страх', 'беспокойство', 'нервничаю', 'дрожь'],
        ...
        resources: [
          ...
          'Статья: "Тревога и панические атаки в трезвости"'
        ]
      },
      {
        keyword: ['гнев', 'злость', 'раздражение', 'бешенство', 'ярость', 'бесит'],
        ...
        resources: [
          ...
          'Статья: "Управление гневом в трезвости"'
        ]
      },
      {
        keyword: ['депрессия', 'грусть', 'печаль', 'тоска', 'безнадежность', 'ничего не хочу'],
        ...
        resources: [
          ...
          'Статья: "Работа с депрессией в восстановлении"'
        ]
      },
      {
        keyword: ['скука', 'скучно', 'нечем заняться', 'серость', 'пустота'],
        response: 'Скука в трезвости - это признак того, что ваша дофаминовая система восстанавливается. Раньше алкоголь давал "искусственную яркость", теперь мозгу нужно время, чтобы снова научиться радоваться простым вещам.',
        techniques: [
          'Список 20 удовольствий: напишите 20 вещей, которые приносят радость без алкоголя',
          'Эксперимент недели: каждую неделю пробуйте одно совершенно новое хобби',
          'Mindfulness: учитесь присутствовать в моменте скуки, наблюдайте за ней',
          'Волонтерство: помощь другим - лучший способ наполнить жизнь смыслом'
        ],
        resources: [
          'Статья: "Скука в трезвости: новый источник смысла"',
          'Книга: "Поток" Михай Чиксентмихайи',
          'Список идей для хобби в приложении'
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        keyword: ['хочу выпить', 'тяга', 'искушение', 'соблазн', 'желание выпить'],
        ...
        resources: [
          ...
          'Статья: "Работа с тягой: техники в моменте"'
        ]
      },
      {
        keyword: ['триггер', 'запускает', 'провоцирует', 'напоминает', 'обстановка'],
        ...
        resources: [
          ...
          'Статья: "Триггеры: как их распознать и управлять ими"'
        ]
      },
      {
        keyword: ['срыв', 'сорвался', 'выпил', 'все пропало', 'ошибка'],
        response: 'Срыв - это не конец пути, а важная точка обучения. Главное сейчас - не впадать в самобичевание, а проанализировать ситуацию и вернуться в трезвость прямо сейчас. Ваша прошлая трезвость никуда не делась.',
        techniques: [
          'Анализ срыва: Что произошло за 48 часов до? Какая была эмоция? Какая мысль?',
          'План 24 часов: сфокусируйтесь только на том, чтобы быть трезвым следующие 24 часа',
          'Техника "Прощение себя": признайте ошибку, но не делайте ее своей личностью',
          'Звонок поддержки: честно расскажите о случившемся близкому человеку'
        ],
        resources: [
          'Статья: "Переопределение успеха и неудачи"',
          'Группы поддержки (АА, SMART Recovery)',
          'Книга: "Путь к выздоровлению" Стефани Браун'
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        keyword: ['все или ничего', 'идеально', 'перфекционизм', 'крайности'],
  ...
  },
  {
    ...
    topics: [
      {
        keyword: ['друзья пьют', 'компания', 'вечеринка', 'давление', 'праздник'],
        ...
        resources: [
          ...
          'Статья: "Установление границ с пьющим окружением"'
        ]
      },
      {
        keyword: ['одиночество', 'изоляция', 'нет друзей', 'один', 'никто не понимает'],
  ...
  },
  {
    ...
    topics: [
      {
        keyword: ['стыд', 'вина', 'позор', 'ненавижу себя', 'совесть'],
        ...
        resources: [
          ...
          'Статья: "Прощение себя: работа со стыдом и виной"'
        ]
      },
      {
        keyword: ['кто я', 'идентичность', 'потерял себя', 'не знаю кто я'],
  ...
  },
  {
    ...
    topics: [
      {
        keyword: ['стресс', 'перегрузка', 'не справляюсь', 'давит', 'тяжело'],
        ...
        resources: [
          ...
          'Статья: "DBT навыки для толерантности к дистрессу"'
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        keyword: ['не могу спать', 'бессонница', 'плохой сон', 'кошмары'],
        ...
        resources: [
          ...
          'Статья: "Сон без алкоголя: гигиена и ритуалы"'
        ]
      },
      {
        keyword: ['печень', 'здоровье', 'организм', 'восстановление тела'],
        response: 'Ваше тело обладает удивительной способностью к исцелению. После отказа от алкоголя процессы регенерации запускаются мгновенно. Важно поддержать организм правильным питанием и режимом.',
        techniques: [
          'Детокс-диета: больше воды, крестоцветных овощей, куркумы',
          'Легкие упражнения: ходьба стимулирует лимфодренаж',
          'Витаминная поддержка: витамины группы B после консультации с врачом',
          'HALT проверка: своевременное питание предотвращает тягу'
        ],
        resources: [
          'Статья: "Суперфуды для восстановления печени"',
          'Статья: "Как алкоголь влияет на мозг"',
          'Книга: "Тело помнит все" Бессел ван дер Колк'
        ]
      }
    ]
  },
  {
    category: 'Травма и ПТСР',
    topics: [
      {
        keyword: ['травма', 'птср', 'прошлое', 'воспоминания', 'насилие', 'детство'],
        response: 'Многие используют алкоголь как самолечение при травматическом опыте. Важно понимать, что трезвость - это первый шаг к исцелению травмы, но сама травма требует работы со специалистом.',
        techniques: [
          'Техники заземления: возврат в "здесь и сейчас" при флешбэках',
          'Создание "Безопасного места": мысленная визуализация пространства спокойствия',
          'Работа с телом: йога или танцевальная терапия (соматический подход)',
          'Дневник самонаблюдения: выявление связи между триггерами травмы и тягой'
        ],
        resources: [
          'Статья: "Работа с травмой и ПТСР"',
          'Книга: "Тело помнит все" Бессел ван дер Колк',
          'Поиск травма-терапевта (EMDR, соматическая терапия)'
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        keyword: ['жена', 'муж', 'семья', 'дети', 'родители', 'созависимость'],
        response: 'Зависимость - это семейная болезнь. Ваши близкие тоже пострадали и им нужно время на восстановление. Доверие возвращается долго, но последовательная трезвость - лучший способ его вернуть.',
        techniques: [
          'Установление здоровых границ: учитесь говорить "нет" без вины',
          'Семейная коммуникация: используйте "Я-сообщения"',
          'Терпение к близким: примите их гнев и подозрительность как часть процесса',
          'Совместный досуг: планируйте активности, не связанные с алкоголем'
        ],
        resources: [
          'Статья: "Созависимость: как выйти из замкнутого круга"',
          'Статья: "Восстановление доверия в семье"',
          'Группы Al-Anon (для близких)'
        ]
      }
    ]
  }
...
export function findRelevantKnowledge(userMessage: string): {
  ...
  // Приоритетный поиск по точным совпадениям ключевых слов
