...
export class CommunityService {
  ...
  /**
   * ИИ-модерация содержимого поста. Фильтрует прямую токсичность и оскорбления,
   * но при этом разрешает употреблять названия веществ, так как это важно для терапии.
   */
  static moderatePostContent(content: string): { isApproved: boolean; reason?: string } {
    const lower = content.toLowerCase();

    // Список недопустимых грубых оскорблений
    const toxicWords = ['дебил', 'идиот', 'придурок', 'ублюдок', 'мразь', 'урод', 'тупой', 'сука', 'тварь', 'сволочь'];

    const foundToxic = toxicWords.find(word => lower.includes(word));
    if (foundToxic) {
      return {
        isApproved: false,
        reason: `Ваш пост содержит неподобающее выражение ("${foundToxic}"). Сообщество Sober Path поддерживает уважительное общение.`
      };
    }
  ...
  static getSuccessStories(): SuccessStory[] {
    return [
      ...
      },
      {
        ...
        userName: 'Кристина К.',
        daysSober: 95,
        story: 'Сначала я сомневалась, но со временем осознала, как много энергии забирал алкоголь. Сейчас я чувствую себя невероятно легкой и счастливой!',
      ...
      },
      {
        ...
        userName: 'Роман П.',
        daysSober: 180,
        story: 'Полгода без алкоголя. Финансовое положение улучшилось в разы, ушли депрессивные мысли. Всем рекомендую завести дневник и фиксировать прогресс.',
        avatar: 'https://i.pravatar.cc/150?u=roman',
        date: '2024-05-05'
      },
      {
        id: '16',
        userName: 'Алена Г.',
        daysSober: 45,
        story: '45 дней свободы! Перестали сниться кошмары, восстановился здоровый и глубокий сон. Поняла, что трезвая жизнь безумно интересна.',
        avatar: 'https://i.pravatar.cc/150?u=alena',
        date: '2024-05-08'
      },
      {
        id: '17',
        userName: 'Владислав Д.',
        daysSober: 300,
        story: 'Почти год. Нашел новые увлечения — походы и велоспорт. Рад, что сделал этот выбор вовремя. Не бойтесь менять свою жизнь!',
        avatar: 'https://i.pravatar.cc/150?u=vladislav',
        date: '2024-05-12'
      },
      {
        id: '18',
        userName: 'Евгений М.',
        daysSober: 15,
        story: 'Две недели чистоты. Появилась ясность в голове. Сложно бороться со скукой по вечерам, но сообщество спасает своими советами!',
        avatar: 'https://i.pravatar.cc/150?u=evgeny',
        date: '2024-05-15'
      }
    ];
  }
  ...
  static getExpertQA(): ExpertQA[] {
    return [
      ...
      {
        id: 'q21',
        question: 'Как восстановить водно-солевой баланс и печень после долгих лет употребления?',
        answer: 'Восстановление требует времени. Первые шаги — употребление не менее 2 литров чистой воды в день, добавление в рацион продуктов, богатых антиоксидантами (ягоды, зелень, орехи), и минимизация трансжиров. Обязательно сдайте биохимический анализ крови и обратитесь к терапевту.',
        expertName: 'Д-р Анна Смирнова',
        expertTitle: 'Нарколог-психотерапевт',
        date: '2024-05-18'
      },
      {
        id: 'q22',
        question: 'Что делать, если тяга приходит во время сильной скуки?',
        answer: 'Скука — частый триггер, так как мозг привык получать "дешевый дофамин". Займитесь тем, что требует вовлечения: соберите пазл, запишитесь на онлайн-курс, начните учить иностранный язык. Создайте список занятий на случай скуки заранее.',
        expertName: 'Алексей Соколов',
        expertTitle: 'Клинический психолог',
        date: '2024-05-20'
      },
      {
        id: 'q23',
        question: 'Как реагировать на шутки знакомых по поводу моей трезвости?',
        answer: 'Шутки — это часто защитная реакция людей на их собственное неудобство. Будьте спокойны и тверды. Достаточно сказать: "Я чувствую себя отлично без алкоголя, и это мое осознанное решение". Ваша уверенность быстро прекратит подобные разговоры.',
        expertName: 'Игорь Петров',
        expertTitle: 'Аддиктолог',
        date: '2024-05-22'
      },
      {
        id: 'q24',
        question: 'Безалкогольное пиво — это помощь или опасность?',
        answer: 'Для большинства людей в первый год выздоровления это опасность. Вкус и ритуал могут запустить те же нейронные связи в мозге, что и алкогольное пиво, провоцируя сильнейший всплеск тяги (психологический триггер). Лучше избегать имитаций.',
        expertName: 'Алексей Соколов',
        expertTitle: 'Клинический психолог',
        date: '2024-05-25'
      },
      {
        id: 'q25',
        question: 'Как восстановить когнитивные функции и память после отказа от алкоголя?',
        answer: 'Мозг обладает удивительным свойством нейропластичности. Читайте книги, решайте кроссворды, учите стихи или новые слова ежедневно. Полноценный сон от 7-8 часов и физические упражнения ускорят прорастание новых нейронных связей.',
        expertName: 'Елена Кузнецова',
        expertTitle: 'Психотерапевт',
        date: '2024-05-28'
      }
