...
export const microCoursesDatabase: MicroCourse[] = [
  ...
  {
    id: 'relationship_rebuild',
    title: 'Восстановление отношений',
    description: 'Как вернуть доверие близких и наладить здоровое общение после периода зависимости.',
    category: 'growth',
    difficulty: 'advanced',
    icon: 'favorite',
    points: 180,
    lessons: [
      {
        ...
        content: 'Доверие восстанавливается делами, а не словами. Будьте последовательны в своих поступках. Приготовьтесь к тому, что это займет время.',
        duration: 12,
        type: 'text'
      },
      {
        ...
        content: 'Научитесь говорить о своих чувствах без обвинений и защитных реакций. Практикуйте "Я-сообщения".',
        duration: 10,
        type: 'text'
      },
      {
        id: 'rr_l3',
        title: 'Упражнение: Письмо прощения',
        content: 'Напишите письмо близкому человеку, в котором вы искренне признаете свои ошибки, но не оправдываетесь. Вы можете не отправлять его сразу, это важно прежде всего для вас.',
        duration: 20,
        type: 'exercise'
      }
    ]
