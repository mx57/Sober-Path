...
export const microCoursesDatabase: MicroCourse[] = [
  ...
  },
  {
    ...
    description: 'Как восстановить уверенность в себе и общаться легко без алкогольных «допингов».',
    category: 'growth',
    difficulty: 'intermediate',
    icon: 'emoji-people',
    points: 150,
    lessons: [
      {
        id: 'sao_l1',
        title: 'Природа социального страха',
        content: 'Алкоголь часто используется как социальная смазка, маскирующая тревогу. Когда мы убираем его, страх оценки другими обостряется. Поймите: тревога — это просто сигнал организма, готового к действию, а не реальная опасность.',
        duration: 8,
        type: 'text'
      },
      {
        id: 'sao_l2',
        title: 'Упражнение: Заземление в компании',
        content: 'Когда чувствуете панику среди людей, выполните технику заземления. Оглянитесь и назовите мысленно: 3 синих предмета вокруг, почувствуйте 2 physical ощущения (например, стопы на полу), сделайте 1 глубокий выдох. Это мгновенно снизит пульс.',
        duration: 10,
        type: 'exercise'
      },
      {
        id: 'sao_l3',
        title: 'Уверенность без масок',
        content: 'Истинная социальная уверенность строится на принятии себя. Тренируйте удерживать зрительный контакт в течение 3 секунд, говорите в спокойном темпе и помните, что каждый человек больше думает о себе, чем о вас.',
        duration: 12,
        type: 'text'
      }
    ]
